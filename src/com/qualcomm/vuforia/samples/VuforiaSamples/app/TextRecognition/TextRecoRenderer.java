...
import com.qualcomm.vuforia.samples.VuforiaSamples.app.TextRecognition.TextReco.textTSpeech;
...
public class TextRecoRenderer implements GLSurfaceView.Renderer
{
    ...
    private void initRendering()
    {
    	...
    	//t1.speak("Hello, Jose , mi la pelas", TextToSpeech.QUEUE_FLUSH, null);
    ...
    public void renderFrame()
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            if (result.isOfType(WordResult.getClassType()))
            {
                ...
                textTSpeech.t1.speak(wordU, TextToSpeech.QUEUE_FLUSH, null);
                ...
                if (wordU != null)
                {
                    ...
                    if (mWords.size() < MAX_NB_WORDS)
                    {
                        mWords.add(new WordDesc(wordU,
                            ...
                            (int) (wordx + wordBoxSize.getData()[0] / 2),
                            (int) (wordy + wordBoxSize.getData()[1] / 2)));
                        WordDesc talkdirty = mWords.get(mWords.size()-1);
                    }
