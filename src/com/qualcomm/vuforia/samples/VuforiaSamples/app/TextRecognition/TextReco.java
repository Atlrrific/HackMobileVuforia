    ...
    SampleAppMenuInterface
{
    ...
    public static class textTSpeech {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        textTSpeech.t1=new TextToSpeech( getBaseContext(), new TextToSpeech.OnInitListener() {
            @Override
            public void onInit(int status) {
               if(status != TextToSpeech.ERROR) {
            	   textTSpeech.t1.setLanguage(Locale.UK);
               }
            }
         });
        ...
        runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                {	
                    ...
                    {
                    	System.out.printf("MESSAGE" + word.text);
                    	//t1.speak(word.text, TextToSpeech.QUEUE_FLUSH, null);
                        count++;
                        if (count == nbWords)
                        {
                            break;
